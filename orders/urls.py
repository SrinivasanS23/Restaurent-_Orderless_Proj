...
urlpatterns = [
    ...
    path('orders/<int:order_id>/status/', views.update_order_status, name='api-order-status-int'),
    path('orders/<str:order_id>/status/', views.update_order_status, name='api-order-status-str'),
