...
urlpatterns = [
    ...
    path('api/live-orders/', views.orders_list_api, name='admin-dashboard-live-orders'),
    path('api/orders/<str:order_number>/', views.order_detail_api, name='admin-dashboard-order-detail'),
    
    # Tables Matrix
    path('api/tables/', views.tables_matrix_api, name='admin-dashboard-tables'),
    ...
    path('export/customers/', views.export_customers_csv, name='admin-dashboard-export-customers'),
